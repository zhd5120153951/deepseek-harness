# LoongBuddy 基于 DeepSeek Harness 的本地-云端协同智能体平台架构设计
...
LoongBuddy 不建议直接大规模修改 Harness Core，而应该通过 Harness 官方 Extension Point 进行二次开发：
...
LoongBuddy 最终不是一个简单的 ChatBot，而是一个：
...
LoongBuddy 重点利用 Harness 的以下能力：

| Harness 能力 | LoongBuddy 用途 |
|---|---|
| `ctx.llm` | LLM 推理 |
| `ctx.agents` | Agent 管理 |
