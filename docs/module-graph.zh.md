...
flowchart TD
  ...
  pkg_skillhub --> pkg_system_prompt
  pkg_skillhub --> pkg_tools
...
| [`skillhub`](../packages/skill/skillhub) | `skill` | [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
